INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (1, 50, 'Movieplex Theater 1', '941 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (2, 70, 'Movieplex Theater 2', '942 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (3, 70, 'Movieplex Theater 3', '943 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (4, 60, 'Movieplex Theater 4', '944 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (5, 120, 'Movieplex Theater 5', '945 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (6, 100, 'Movieplex Theater 6', '946 Progress Ave, Toronto, ON M1K 5E9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (7, 80, 'Movieplex Theater 7', '947 Progress Ave, Toronto, ON M1K 5E9')
...
INSERT INTO MOVIES("ID", "NAME", "ACTORS") VALUES (14, 'Toy Story', 'TomHanks, Michael Keaton')
INSERT INTO MOVIES("ID", "NAME", "ACTORS") VALUES (15, 'Harry Potter','Daniel Radcliffe, Emma Watson')
INSERT INTO MOVIES("ID", "NAME", "ACTORS") VALUES (16, 'Avatar', 'SamWorthington, Sigourney Weaver')
INSERT INTO MOVIES("ID", "NAME", "ACTORS") VALUES (17, 'Slumdog Millionaire','Anil Kapoor, Dev Patel, Freida Pinto')
INSERT INTO MOVIES("ID", "NAME", "ACTORS") VALUES (18, 'The Curious Case ofBenjamin Button', 'Brad Pitt, Cate Blanchett')
